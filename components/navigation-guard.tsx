...
export function NavigationGuard({ children }: NavigationGuardProps) {
  ...
  useEffect(() => {
    ...
    const protectedRoutes = ["/questions", "/rating", "/thank-you"]
    ...
    if (pathname === "/" && userId) {
      const shouldContinue = confirm("You have an ongoing evaluation. Would you like to continue where you left off?")

...
export default function ClassificationPage() {
  ...
  const handleSubmit = async () => {
    ...
    const completedRubrics =
      currentQuestion.rubrics?.filter((quality) => qualityPassFail[quality]) ||
      [];
              ...
              <div className="flex-1">
                ...
                >
                  <p className="text-sm sm:text-base text-slate-700 dark:text-slate-300 leading-relaxed max-w-6xl">
                    As a medical expert, please review the response below. Each
                    quality is a checklist for a perfect answer. Select Yes if
                    the response meets the quality, or No if it doesn't.
                  </p>
                </div>
              </div>
              <Button
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-xs sm:text-sm text-muted-foreground">
                        {currentQuestion.user_answer === "N/A"
                          ? "0 words"
                    ...
                    <div className="p-4 bg-slate-50 dark:bg-zinc-800/50 rounded-lg border max-h-64 overflow-y-auto">
                      <p className="text-sm whitespace-pre-wrap">
                        {currentQuestion.user_answer === "N/A"
                          ? "You skipped providing an answer for this question."
